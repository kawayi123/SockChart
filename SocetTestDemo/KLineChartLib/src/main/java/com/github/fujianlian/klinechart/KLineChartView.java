    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (array != null) {
            try {
                ...
                setTextColor(array.getColor(R.styleable.KLineChartView_kc_text_color, Color.rgb(111,116,127)));
                setMTextSize(array.getDimension(R.styleable.KLineChartView_kc_text_size, getDimension(R.dimen.chart_text_size)));

                setMTextColor(array.getColor(R.styleable.KLineChartView_kc_text_color, Color.parseColor("#ffffff")));
                setLineWidth(array.getDimension(R.styleable.KLineChartView_kc_line_width, 4));
//                setBackgroundColor(array.getColor(R.styleable.KLineChartView_kc_background_color, getColor(R.color.chart_bac)));
                setBackgroundColor(array.getColor(R.styleable.KLineChartView_kc_background_color, Color.rgb(33,38,54)));

//                setSelectPointColor(array.getColor(R.styleable.KLineChartView_kc_background_color, getColor(R.color.chart_point_bac)));

                setSelectedXLineColor(Color.rgb(41,139,238));
                setSelectedXLineWidth(3);

                setSelectedYLineColor(Color.rgb(32,47,75));
...
//                setGridLineColor(getColor(R.color.chart_ma5));
                ...
                setBarWidth(array.getDimension(R.styleable.KLineChartView_kc_candle_width, 8));
                setBarSpaceRatio(array.getDimension(R.styleable.KLineChartView_kc_candle_width, getDimension(R.dimen.chart_bar_width_space_ratio)));
...
//                mRefreshListener.onLoadMoreBegin(this);
//            }
//            mLastScaleEnable = true;
//            mLastScrollEnable = true;
...
//        }
    ...
    public void setBarWidth(float barWidth) {
        mMainDraw.setBarWidth(barWidth);
    }
     ...
     * @param ratio
     */
    public void setBarSpaceRatio(float ratio) {
        mMainDraw.setBarRatio(ratio);
    }
